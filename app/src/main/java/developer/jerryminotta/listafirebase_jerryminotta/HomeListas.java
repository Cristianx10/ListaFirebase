           ...
           // Toast.makeText(HomeListas.this, "" + auth.getCurrentUser().getUid(), Toast.LENGTH_LONG).show();
            ...
            reference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    Log.e("Nombre", dataSnapshot.getValue().toString());
                    Usuario usuario = dataSnapshot.getValue(Usuario.class);
                   // Toast.makeText(HomeListas.this, ""+usuario.getNombre(), Toast.LENGTH_SHORT).show();
                  tv_bienvenido.setText("Bienvenido "+ usuario.getNombre());
                }
